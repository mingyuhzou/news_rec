...
from recall.transformer.data.qwen_dataset import (
    QwenGenRecDataset,
    QwenGenRecDataLoader
)

from config.model.qwen import cfg

from recall.utils.metrics import (
    ndcg_at_k,
    recall_at_k
)

from recall.transformer.model.Qwen import Qwen
...
def evaluate(
    ...
    with torch.no_grad():
        ...
        for i,batch in enumerate(
            ...
            target = labels[
                :,
                history_len-code_len:
            ]

            target = target[:,:code_len]
